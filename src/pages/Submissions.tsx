...
import {
  ...
  PenLine, AlertCircle, ArrowUpRight, Calendar,
} from "lucide-react";
...
function StatCard({ icon: Icon, label, value, color }: {
  ...
  return (
    <div style={{
      ...
      padding: "1.1rem 1.25rem", display: "flex", alignItems: "center", gap: "0.875rem",
    }}>
    ...
    <Layout>
      <div style={{ display: "flex", minHeight: "calc(100vh - 64px)" }}>
        ...
        <aside style={{
          ...
          background: "#fafafa", padding: "1.5rem 0", display: "flex", flexDirection: "column",
          ...
          {[
            ...
            { icon: PenLine,     label: "Create a Special Issue", to: "/publishing/special-issue" },
          ].map(({ icon: Icon, label, to, count, active }) => (
            <Link
              key={to} to={to}
              style={{
        ...
        <main style={{ flex: 1, padding: "2rem", overflowX: "auto" }}>
          ...
          <div style={{ marginBottom: "1.75rem" }}>
            ...
            <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", flexWrap: "wrap", gap: "1rem" }}>
              <div>
                <h1 style={{ fontSize: "1.75rem", fontWeight: 800, fontFamily: "Georgia, serif", color: "var(--foreground)", margin: 0 }}>
                  My Submissions
                </h1>
          ...
          <div style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: 14, overflow: "hidden" }}>
            ...
            <div style={{ padding: "1rem 1.25rem", borderBottom: "1px solid #f3f4f6", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "0.75rem" }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "0.625rem", flexWrap: "wrap" }}>
                ...
                <div style={{ position: "relative" }}>
                  ...
                  <input
                    type="text" placeholder="Search submissions..."
                ...
                <button style={{
                  ...
                  <Filter size={13} /> Assign Reviewers
                </button>
              </div>
            </div>
                      ...
                      <td style={{ padding: "1rem", whiteSpace: "nowrap" }}>
                        <div style={{ display: "flex", alignItems: "center", gap: "0.375rem" }}>
                          <button style={{
                            ...
                            padding: "0.35rem 0.625rem", cursor: "pointer", fontSize: "0.75rem",
                            fontWeight: 600, color: "var(--foreground)",
                            display: "flex", alignItems: "center", gap: "0.3rem", transition: "background 0.12s",
                          }}
            ...
            {/* Footer */}
            <div style={{ padding: "0.875rem 1.25rem", borderTop: "1px solid #f3f4f6", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
