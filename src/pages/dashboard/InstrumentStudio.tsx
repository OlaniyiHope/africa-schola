...
function SurveyPreview({ title, type, users, toast: t }: any) {
  return (
    <div className="space-y-4">
      ...
      <Button  size="lg" className="w-full" onClick={() => t({ title: "Response submitted!", description: "Thank you for completing this instrument." })}>
        Submit Response
      </Button>
    </div>
  );
...
function AnalyticalPreview({ title, toast: t }: any) {
  ...
  return (
    <div className="space-y-4">
      ...
      <Button  size="sm" className="gap-1" onClick={() => { setRan(true); t({ title: "Analysis complete" }); }}><Play className="h-3 w-3" /> Run Analysis</Button>
...
function ExperimentalPreview({ title, toast: t }: any) {
  ...
  return (
    <div className="space-y-4">
      ...
      <Button  size="sm" className="gap-1" onClick={() => { setRunning(true); setTimeout(() => { setRunning(false); setDone(true); t({ title: "Experiment complete" }); }, 1500); }}>
...
function CalculatorPreview({ title, toast: t }: any) {
  ...
  return (
    <div className="space-y-4">
      ...
      <Button  size="sm" className="gap-1" onClick={() => { setResult("t(48) = 2.34, p = 0.023, Cohen's d = 0.67"); t({ title: "Calculation complete" }); }}><Play className="h-3 w-3" /> Run Calculation</Button>
...
function SimulationPreview({ title, toast: t }: any) {
  ...
  return (
    <div className="space-y-4">
      ...
      <Button  size="sm" className="gap-1" onClick={() => { setRunning(true); setTimeout(() => { setRunning(false); setDone(true); t({ title: "Simulation complete" }); }, 2000); }}>
...
function PolicyPreview({ title, toast: t }: any) {
  ...
  return (
    <div className="space-y-4">
      ...
      <Button  size="sm" className="gap-1" onClick={() => { setDone(true); t({ title: "Model evaluated" }); }}><Play className="h-3 w-3" /> Evaluate Policy</Button>
...
function GenericPreview({ title, type, toast: t }: any) {
  return (
    <div className="space-y-4">
      ...
      <Button  size="sm" className="gap-1" onClick={() => t({ title: "Execution complete" })}><Play className="h-3 w-3" /> Execute</Button>
    </div>
  );
}
        ...
        <Dialog open={showShareModal} onOpenChange={setShowShareModal}>
          <DialogContent className="max-w-sm">
            ...
            <div className="flex flex-col gap-2 mt-3">
              <Button  size="sm" onClick={handleSharePublicly}>Share Publicly</Button>
            ...
            <Dialog open={showCreditConfirm} onOpenChange={setShowCreditConfirm}>
              <DialogContent className="max-w-sm">
                ...
                <div className="flex gap-2 mt-3">
                  ...
                  <Button  size="sm" className="flex-1" onClick={handleBuildConfirm}>Proceed</Button>
                </div>
              </DialogContent>
            </Dialog>

            <Button  size="lg" className="w-full gap-1" onClick={() => setShowCreditConfirm(true)} disabled={building || !title || !type}>
            ...
            <div className="bg-card rounded-xl border border-border overflow-hidden">
              <Tabs defaultValue="preview">
                ...
                <TabsContent value="share" className="p-5 space-y-3">
                  ...
                  <div className="flex gap-2">
                    <Button  size="sm" className="gap-1" onClick={() => window.open(`https://wa.me/?text=${encodeURIComponent(`Check out my research instrument on Afrika Scholar: https://afrikascholar.com/i/new-instrument`)}`, "_blank")}>
                      <ExternalLink className="h-3 w-3" /> WhatsApp
                    </Button>
                    <Button  size="sm" className="gap-1" onClick={() => window.open(`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://afrikascholar.com/i/new-instrument")}`, "_blank")}>
                      ...
                      <Dialog>
                        ...
                        <DialogContent className="max-w-sm">
                          ...
                          <div className="flex gap-2 mt-2">
                            ...
                            <Button  size="sm" className="flex-1 gap-1" onClick={() => window.open(`https://wa.me/?text=${encodeURIComponent(inst.link)}`, "_blank")}>
                              <ExternalLink className="h-3 w-3" /> WhatsApp
                            </Button>
                            <Button  size="sm" className="flex-1 gap-1" onClick={() => window.open(`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(inst.link)}`, "_blank")}>
                              <ExternalLink className="h-3 w-3" /> LinkedIn
                            </Button>
                          </div>
                        </DialogContent>
