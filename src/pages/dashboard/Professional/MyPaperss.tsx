 ...
 <DashboardLayout role={role}>
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div className="flex items-start justify-between">
          ...
          <Link to="/dashboard/professional/intelligence/generate-paper">
            ...
            {papers.map((paper) => (
              <div key={paper.id} className="bg-card rounded-xl border border-border p-5 space-y-3">
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  <Link to="/dashboard/professional/publishing/submit">
                  ...
                  <Dialog>
                    ...
                    <DialogContent className="max-w-sm">
                      ...
                      <div className="flex gap-2 mt-2">
                        ...
                        <Button  size="sm" className="gap-1 flex-1" onClick={() => window.open(`https://wa.me/?text=${encodeURIComponent(`I just published a research article on Afrika Scholar. Read here: https://afrikascholar.com/papers/${paper.id}`)}`, "_blank")}>
                          <ExternalLink className="h-3 w-3" /> WhatsApp
                        </Button>
                        <Button  size="sm" className="gap-1 flex-1" onClick={() => window.open(`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(`https://afrikascholar.com/papers/${paper.id}`)}`, "_blank")}>
