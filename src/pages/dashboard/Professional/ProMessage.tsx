                    ...
                    {activeConvo.status === "request" && (
                      <div className="bg-secondary rounded-xl p-4 text-center space-y-3">
                        ...
                        <div className="flex gap-2 justify-center">
                          <Button  size="sm" onClick={() => handleAcceptRequest(activeConvo.id)}>Accept</Button>
                          <Button  size="sm" onClick={() => handleIgnoreRequest(activeConvo.id)}>Ignore</Button>
                        </div>
                      </div>
                    )}
                  ...
                  {activeConvo.status !== "request" && (
                    <div className="p-3 border-t border-border flex items-center gap-2">
                      <Input
                        ...
                        className="flex-1"
                      />
                      <Button  size="sm" disabled={!newMessage.trim()} onClick={handleSendMessage}>
