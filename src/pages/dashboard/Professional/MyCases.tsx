        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center py-20">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              <Link to="/dashboard/advisory/transcripts"><Button  className="gap-1.5"><FileText className="h-4 w-4" /> Request Transcript</Button></Link>
              <Link to="/dashboard/advisory/degree"><Button  className="gap-1.5"><GraduationCap className="h-4 w-4" /> Request Degree Advisory</Button></Link>
              <Link to="/dashboard/advisory/study-africa"><Button  className="gap-1.5"><Globe className="h-4 w-4" /> Explore Study in Africa</Button></Link>
            </div>
          </div>
        </div>
      </DashboardLayout>
                ...
                return (
                  <TableRow key={c.id}>
                    ...
                    <TableCell className="text-right space-x-1">
                      ...
                      <Link to="/dashboard/professional/messages">
        ...
        <DialogContent className="max-w-md">
          ...
          {viewCase && (
            <div className="space-y-4 text-sm">
              ...
              <Link to="/dashboard/professional/messages" className="block">
