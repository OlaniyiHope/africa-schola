...
const recentActivity = [
  { text: "Transcript request submitted — University of Ibadan", time: "2 hours ago", link: "/dashboard/professional/advisory/transcripts" },
  { text: "Degree advisory requested — Data Science master's programs", time: "1 day ago", link: "/dashboard/professional/advisory/degree" },
  { text: "Advisor response received — Study in Africa consultation", time: "2 days ago", link: "/dashboard/professional/advisory/cases" },
  { text: "Document uploaded — BSc Economics Transcript", time: "3 days ago", link: "/dashboard/professional/advisory/documents" },
  { text: "Academic pathway guidance completed", time: "5 days ago", link: "/dashboard/professional/advisory/pathways" },
];

const quickActions = [
  { icon: FileText, title: "Request Transcript", desc: "Process academic transcripts", link: "/dashboard/professional/advisory/transcripts" },
  { icon: GraduationCap, title: "Degree Advisory", desc: "Get program guidance", link: "/dashboard/professional/advisory/degree" },
  { icon: Globe, title: "Study in Africa", desc: "Explore universities", link: "/dashboard/professional/advisory/study-africa" },
  { icon: Compass, title: "Academic Pathways", desc: "Plan your career", link: "/dashboard/professional/advisory/pathways" },
];
          ...
          <div>
            ...
            <div className="bg-card rounded-xl border border-border p-5 space-y-3">
              <Link to="/dashboard/advisory/cases">
                <Button className="w-full gap-1.5 justify-start" >
