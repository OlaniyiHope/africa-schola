      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <Dialog open={showShareModal} onOpenChange={setShowShareModal}>
          <DialogContent className="max-w-sm">
            ...
            <div className="flex flex-col gap-2 mt-3">
              <Button  size="sm" onClick={() => { setShowShareModal(false); toast({ title: "Shared to community!" }); }}>Share Publicly</Button>
        ...
        {!generated && (
          <div className="bg-card rounded-xl border border-border p-6 space-y-5">
            ...
            <div className="pt-2">
              {paperCredits > 0 ? (
                <Button  size="lg" className="w-full" onClick={handleGenerate} disabled={generating || !topic}>
                ...
                <div className="text-center space-y-3 p-4 border border-destructive/30 rounded-xl bg-destructive/5">
                  ...
                  <div className="flex gap-3 justify-center">
                    <Link to="/publeesh/pricing"><Button  size="sm">Upgrade Plan</Button></Link>
        ...
        {generated && (
          <>
            ...
            <div className="flex flex-wrap gap-3">
              <Button  size="sm" className="gap-1"><FileText className="h-4 w-4" /> View Generated Paper</Button>
            ...
            <div className="flex flex-wrap gap-3">
              <Link to="/dashboard/publishing/submit"><Button  size="sm" className="gap-1"><Send className="h-4 w-4" /> Submit for Publication</Button></Link>
...
export default GeneratePaperss;
