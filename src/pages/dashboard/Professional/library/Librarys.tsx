              ...
              <div className="space-y-3">
                {saved.filter(s => filterBySearch(s.title)).length > 0 ? (
                  ...
                  <div className="bg-card rounded-xl border border-border p-12 text-center">
                    ...
                    <Link to="/dashboard/intelligence">
                      <Button  size="sm" className="mt-3 gap-1.5"><Search className="h-3.5 w-3.5" /> Explore Research</Button>
                    </Link>
                  </div>
                )}
              </div>
              ...
              <div>
                {downloads.filter(d => filterBySearch(d.title)).length > 0 ? (
                  ...
                  <div className="bg-card rounded-xl border border-border p-12 text-center">
                    ...
                    <Link to="/dashboard/intelligence">
                      <Button size="sm" className="mt-3 gap-1.5"><BookOpen className="h-3.5 w-3.5" /> Browse Research Library</Button>
                    </Link>
                  </div>
                )}
              </div>
              ...
              <div className="space-y-5">
                ...
                <div className="flex items-center justify-between">
                  ...
                  {browseMode ? (
                    ...
                    <Button  size="sm" className="gap-1.5" onClick={() => setBrowseMode(true)}>
                ...
                {!browseMode && (
                  activeSubs.length > 0 ? (
                    ...
                    <div className="bg-card rounded-xl border border-border p-16 text-center">
                      ...
                      <Button  className="gap-2" onClick={() => setBrowseMode(true)}>
          ...
          {subscribeStep === "form" && subscribeTarget && (
            <>
              ...
              <DialogFooter className="gap-2">
                ...
                <Button  size="sm" disabled={subscribing} onClick={async () => {
                  setSubscribing(true);
      ...
      <Dialog open={createListDialog} onOpenChange={setCreateListDialog}>
        <DialogContent className="max-w-sm">
          ...
          <DialogFooter>
            ...
            <Button  size="sm" disabled={!listForm.name.trim() || saving} onClick={async () => {
              setSaving(true);
    ...
    <Dialog open={!!paper} onOpenChange={() => onClose()}>
      <DialogContent className="max-w-2xl max-h-[85vh] flex flex-col">
        ...
        <div className="flex gap-2 pt-3 border-t border-border flex-wrap">
          <Button  size="sm" className="gap-1.5" onClick={() => onDownload(paper)}>
