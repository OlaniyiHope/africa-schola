...
const serviceCards = [
  { title: "Request Lecturer Support", desc: "Find academic lecturers and instructors for programs.", icon: GraduationCap, link: "/dashboard/professional/institutions/lecturer-requests", color: "text-accent", bg: "bg-accent/10" },
  { title: "Request Research Collaboration", desc: "Partner with academics for joint research projects.", icon: Handshake, link: "/dashboard/professional/institutions/collaboration", color: "text-primary", bg: "bg-primary/10" },
  { title: "Curriculum Development", desc: "Request curriculum design or academic program support.", icon: BookOpen, link: "/dashboard/professional/institutions/curriculum", color: "text-afrika-green", bg: "bg-afrika-green/10" },
  { title: "Academic Validation", desc: "Request peer review, validation, and academic verification.", icon: Shield, link: "/dashboard/professional/institutions/curriculum", color: "text-afrika-orange", bg: "bg-afrika-orange-light" },
  { title: "Policy Advisory", desc: "Engage academic experts for policy advisory.", icon: Compass, link: "/dashboard/professional/institutions/advisory", color: "text-accent", bg: "bg-accent/10" },
  { title: "Institution Partnership", desc: "Partner with the Afrika Scholar network.", icon: Building2, link: "/dashboard/professional/institutions/my-requests", color: "text-primary", bg: "bg-primary/10" },
];
      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div>
          <div className="flex items-center justify-between mb-3">
            ...
            <Link to="/dashboard/professional/institutions/my-requests" className="text-xs text-accent font-medium hover:underline flex items-center gap-1">
