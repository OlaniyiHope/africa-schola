      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="text-center">
          <h1 className="text-2xl font-bold text-foreground">
            <span className="heading-serif text-accent italic">Professional</span> Community
          </h1>
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="bg-card rounded-xl border border-border p-5 space-y-3">
              ...
              <div className="flex items-center justify-between">
                ...
                <Button  size="sm" className="gap-1" onClick={createPost}><Send className="h-3 w-3" /> Post</Button>
              </div>
            </div>
            ...
            {filteredPosts.length === 0 && tab === "Liked" && (
              <div className="bg-card rounded-xl border border-border p-12 text-center">
                ...
                <Button  size="sm" className="mt-3" onClick={() => setTab("All Posts")}>Back to Community</Button>
              </div>
            )}
            {filteredPosts.length === 0 && tab === "Connected" && (
              <div className="bg-card rounded-xl border border-border p-12 text-center">
                ...
                <Link to="/dashboard/intelligence?tab=stakeholders">
                  <Button  size="sm" className="mt-3">Discover Researchers</Button>
                </Link>
              </div>
            )}
            {filteredPosts.length === 0 && (tab === "All Posts" || tab === "Research Papers" || tab === "Questions" || tab === "Datasets" || tab === "Collaborations") && (
              <div className="bg-card rounded-xl border border-border p-12 text-center">
                ...
                <Button  size="sm" className="mt-3 gap-1" onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}>
