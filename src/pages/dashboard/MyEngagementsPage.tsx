            ...
            <CardContent className="py-12 text-center">
              ...
              <div className="flex flex-wrap items-center justify-center gap-3 mt-5">
                <Link to="/dashboard/institutional/lecturers">
                  <Button  size="sm" className="gap-2"><Search className="h-3.5 w-3.5" />Search Lecturers</Button>
                </Link>
                <Link to="/dashboard/institutional/talent-requests">
                  <Button  size="sm" className="gap-2"><Plus className="h-3.5 w-3.5" />Create Talent Request</Button>
                </Link>
