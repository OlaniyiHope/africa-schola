 ...
 <DashboardLayout role={role}>
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="generate" className="space-y-5">
            <div className="bg-card rounded-xl border border-border p-6 space-y-5">
              ...
              {datasetCredits > 0 ? (
                <Button size="lg" className="w-full" onClick={handleGenerate} disabled={generating || !description}>
                ...
                <div className="text-center space-y-3 p-4 border border-destructive/30 rounded-xl bg-destructive/5">
                  ...
                  <div className="flex gap-3 justify-center">
                    <Link to="/dashboard/billing"><Button  size="sm">Upgrade Plan</Button></Link>
            ...
            {dataGenerated && (
              <div className="bg-afrika-green/10 border border-afrika-green/30 rounded-xl p-4 flex items-center justify-between">
                ...
                <div className="flex gap-2">
                  ...
                  <Button  size="sm" onClick={() => setActiveTab("analyze")}>Analyze Now</Button>
                </div>
              </div>
            )}
          </TabsContent>
          ...
          <TabsContent value="view" className="space-y-5">
            ...
            <div className="flex gap-3">
              <Button  size="sm" className="gap-1"><Download className="h-4 w-4" /> Download CSV</Button>
              ...
              <Link to="/dashboard/data/analyzer">
                <Button  size="sm" className="gap-1"><BarChart3 className="h-4 w-4" /> Analyze Dataset</Button>
              </Link>
            </div>
            ...
            {analysisComplete && (
              <div className="bg-card rounded-xl border border-border p-6 space-y-4">
                ...
                <Link to="/dashboard/generate-paper">
                  <Button  size="sm" className="gap-1 mt-2">Generate Research Paper from Analysis <ArrowRight className="h-4 w-4" /></Button>
                </Link>
              </div>
            )}
          </TabsContent>
        ...
        <div className="flex gap-3 pt-4">
          ...
          <Link to="/dashboard/generate-paper"><Button  size="sm">Generate Paper</Button></Link>
        </div>
      </div>
    </DashboardLayout>
  );
