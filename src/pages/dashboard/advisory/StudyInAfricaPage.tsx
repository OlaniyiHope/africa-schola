            ...
            <Card key={p.id} className="border-border hover:shadow-md transition-shadow">
              <CardContent className="pt-5 pb-4 px-5">
                ...
                <div className="flex gap-2">
                  <Button  size="sm" className="text-xs gap-1 flex-1" onClick={() => setViewProgram(p)}>
          ...
          {viewProgram && (
            <div className="space-y-3 text-sm">
              ...
              <div className="flex gap-2 pt-2">
                ...
                <Button  size="sm" className="flex-1 gap-1"><Handshake className="h-3 w-3" /> Request Advisory</Button>
              </div>
            </div>
          )}
        </DialogContent>
