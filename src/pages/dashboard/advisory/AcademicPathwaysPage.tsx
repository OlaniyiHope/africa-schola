            ...
            <Card key={p.id} className="border-border hover:shadow-md transition-shadow">
              <CardContent className="pt-5 pb-4 px-5">
                ...
                <div className="flex gap-2">
                  <Button size="sm" className="text-xs flex-1" onClick={() => setViewPathway(p)}>
                    View Details
                  </Button>
          ...
          {viewPathway && (
            <div className="space-y-4 text-sm">
              ...
              <div className="flex gap-2 pt-2">
                <Button size="sm" className="flex-1 gap-1" onClick={() => { handleRequestGuidance(viewPathway); setViewPathway(null); }}>
