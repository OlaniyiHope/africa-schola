...
const DEMO_APPLICATIONS: Application[] = [
  {
    ...
    expertise: "Public Health Policy", opportunity: "EdTech Epidemiology Course",
  ...
  },
  {
    ...
    expertise: "Agricultural Economics", opportunity: "Climate-Smart Agriculture Research Lead",
  ...
  },
  {
    ...
    expertise: "Environmental Science", opportunity: "Climate Adaptation Policy Advisory",
      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Review academic applications for your institutional requests.
          </p>
        </div>
              ...
              <div className="mt-6 space-y-6">
                ...
                <div className="flex flex-wrap gap-2 pt-4 border-t border-border">
                  <Button size="sm" variant="outline" onClick={() => handleAction("Shortlisted", selected.applicantName)}>
                    <Star className="h-3.5 w-3.5 mr-1.5" /> Shortlist Candidate
                  </Button>
                  <Button size="sm" variant="outline" onClick={() => handleAction("Invited to interview", selected.applicantName)}>
                    <UserCheck className="h-3.5 w-3.5 mr-1.5" /> Invite to Interview
                  </Button>
                  <Button size="sm" onClick={() => handleAction("Accepted", selected.applicantName)}>
                    <CheckCircle className="h-3.5 w-3.5 mr-1.5" /> Accept Application
                  </Button>
                </div>
              </div>
            </>
