...
import { ChevronRight, Download, MessageCircle, Eye } from "lucide-react";
                    ...
                    <tr key={i} className="hover:bg-secondary/20 transition-colors">
                      ...
                      <td className="px-5 py-3 text-right">
                        <div className="flex justify-end gap-2">
                          ...
                          <Button variant="outline" size="sm" className="text-xs h-7 gap-1" onClick={() => toast.info("Opening messenger...")}>
                            <MessageCircle className="h-3 w-3" /> Message
                          </Button>
                          <Button variant="ghost" size="sm" className="text-xs h-7 gap-1" onClick={() => toast.info("Downloading summary...")}>
