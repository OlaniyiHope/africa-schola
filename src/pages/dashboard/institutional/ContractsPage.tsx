      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Manage agreements with academics for courses, research projects, and advisory work.
          </p>
        </div>
                ...
                {filtered.map((c) => {
                  ...
                  return (
                    <TableRow key={c.id}>
                      ...
                      <TableCell className="hidden lg:table-cell text-muted-foreground">{c.engagementType}</TableCell>
              ...
              <div className="mt-6 space-y-6">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <Button size="sm" variant="outline" onClick={() => handleAction("Milestone marked complete for", selected.title)}>
                    <CheckCircle className="h-3.5 w-3.5 mr-1.5" /> Mark Milestone Complete
                  </Button>
