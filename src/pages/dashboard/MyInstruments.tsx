      ...
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div className="flex items-start justify-between">
          ...
          <Link to="/dashboard/instrument-studio">
            <Button  size="sm" className="gap-1"><Plus className="h-3 w-3" /> Create New</Button>
          </Link>
        </div>
                      ...
                      <Dialog>
                        ...
                        <DialogContent className="max-w-sm">
                          ...
                          <div className="flex gap-2 mt-2">
                            ...
                            <Button  size="sm" className="flex-1 gap-1"><ExternalLink className="h-3 w-3" /> WhatsApp</Button>
                            <Button   className="flex-1 gap-1"><ExternalLink className="h-3 w-3" /> LinkedIn</Button>
                          </div>
                        </DialogContent>
                      </Dialog>
                    </>
