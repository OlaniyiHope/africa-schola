            ...
            <div className="flex flex-col sm:flex-row sm:items-end gap-4">
              ...
              <div className="flex-1 min-w-0 pt-2">
                ...
                <div className="flex items-center gap-2 flex-wrap mt-1">
                 ...
                 {role && (
  <Badge variant="outline" className="text-xs capitalize text-primary-foreground border-primary-foreground/30">
    {role.replace("_", " ")}
  </Badge>
)}
                </div>
            ...
            <section className="bg-card rounded-xl border border-border p-6">
              ...
              {!isOwner && (
                <div className="flex gap-2 mt-4">
                  <Button size="sm" className="gap-1.5"><Handshake className="h-3.5 w-3.5" /> Request Collaboration</Button>
      ...
      <Dialog open={addCredDialog} onOpenChange={setAddCredDialog}>
        <DialogContent className="max-w-md">
          ...
          <DialogFooter>
            ...
            <Button  size="sm" disabled={saving || !credForm.degree || !credForm.field_of_study || !credForm.university} onClick={async () => {
              setSaving(true);
              await addCredential({
      ...
      <Dialog open={addPubDialog} onOpenChange={setAddPubDialog}>
        <DialogContent className="max-w-md">
          ...
          <DialogFooter>
            ...
            <Button  size="sm" disabled={saving || !pubForm.title} onClick={async () => {
              setSaving(true);
      ...
      <Dialog open={addInterestDialog} onOpenChange={setAddInterestDialog}>
        <DialogContent className="max-w-sm">
          ...
          <DialogFooter>
            ...
            <Button  size="sm" disabled={!interestName.trim()} onClick={async () => {
