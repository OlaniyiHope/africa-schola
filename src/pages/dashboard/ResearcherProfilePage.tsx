          ...
          <div className="bg-card rounded-xl border border-border p-12 text-center space-y-3">
            ...
            <div className="flex gap-2 justify-center mt-4">
              <Link to="/dashboard/community">
                <Button size="sm">Back to Community</Button>
              </Link>
                ...
                <div className="px-6 pb-6 -mt-10">
                  ...
                  {profile.user_id !== user?.id && (
                    <div className="flex gap-2 mt-5 flex-wrap">
                      <Button  size="sm" className="gap-1.5" onClick={() => setMessageModal(true)}>
        ...
        <DialogContent className="max-w-md">
          ...
          <div className="space-y-4 mt-2">
            ...
            <div className="flex gap-2 justify-end">
              ...
              <Button  size="sm" className="gap-1.5" onClick={handleSendRequest} disabled={!messageText.trim() || sending}>
