          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="space-y-1">
                <Button size="sm" className="gap-1" onClick={handleRefresh} disabled={refreshing}>
                    ...
                    <DialogContent>
                      ...
                      <div className="space-y-3 text-sm">
                        ...
                        <Link to="/dashboard/publishing/submit">
                          <Button  size="sm" className="w-full gap-1"><Send className="h-3 w-3" /> Submit Paper</Button>
                        </Link>
                      </div>
                    </DialogContent>
                  </Dialog>
                  ...
                  <div className="flex gap-2">
                    <Dialog>
                      ...
                      <DialogContent>
                        ...
                        <Button  size="sm" className="w-full mt-2" onClick={() => toast({ title: "Request sent", description: `Connection request sent to ${s.name}.` })}>Send Request</Button>
                      </DialogContent>
                    </Dialog>
              ...
              <div key={g.title} className="bg-card rounded-xl border border-border p-5 space-y-3">
                ...
                <div className="flex flex-col gap-2">
                  <Link to={`/dashboard/generate-paper?topic=${encodeURIComponent(g.title)}`}>
                    <Button  size="sm" className="w-full gap-1 text-xs"><FileText className="h-3 w-3" /> Generate Proposal</Button>
                  </Link>
              ...
              <div key={t.title} className="bg-card rounded-xl border border-border p-5 space-y-3">
                ...
                <div className="flex gap-2 flex-wrap">
                  ...
                  <Link to={`/dashboard/generate-paper?topic=${encodeURIComponent(t.title)}`}>
                    <Button  size="sm" className="text-xs gap-1"><FileText className="h-3 w-3" /> Generate Outline</Button>
                  </Link>
