              ...
              <div className="py-16 text-center px-4">
                ...
                {!activeStage && (
                  <Link to="/dashboard/publishing/submit">
                    <Button  size="sm" className="mt-4 gap-1.5 text-xs">Submit Manuscript</Button>
                  </Link>
                )}
              </div>
            ) : (
                    ...
                    {selectedMs.workflow_stage === "revision_required" ? (
                      <>
                        ...
                        <div className="flex gap-2">
                          ...
                          <Button  size="sm" className="gap-1.5 text-xs" onClick={() => { toast.success("Revision accepted."); setActiveTab("decision"); }}>
                    ...
                    {(selectedMs.status === "accepted" || selectedMs.workflow_stage === "publication") ? (
                      <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-xl p-8 text-center">
                        ...
                        <div className="flex gap-3 justify-center">
                          ...
                          <Button size="sm" className="gap-1.5" onClick={() => toast.success("Manuscript published successfully!")}>
        ...
        <Dialog open={assignOpen} onOpenChange={(o) => { setAssignOpen(o); if (!o) { setSelectedReviewer(null); setReviewerSearch(""); } }}>
          <DialogContent className="max-w-2xl max-h-[85vh] overflow-y-auto">
            ...
            <DialogFooter>
              ...
              <Button  disabled={!selectedReviewer} onClick={handleAssignReviewer}>
            ...
            {decisionSent ? (
              ...
              <div className="space-y-4">
                ...
                <DialogFooter>
                  ...
                  <Button  disabled={!selectedDecision} onClick={handleSendDecision}>
