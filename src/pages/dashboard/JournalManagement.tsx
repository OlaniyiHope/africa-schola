            ...
            <Tabs value={activeTab} onValueChange={setActiveTab}>
              ...
              <TabsContent value="board" className="space-y-4 mt-4">
                <div className="flex justify-end">
                  <Button  size="sm" className="gap-1" onClick={() => setShowAddMember(true)}>
                ...
                {boardMembers.length === 0 ? (
                  <Card className="border-border">
                    <CardContent className="py-12 text-center">
                      ...
                      <Button  className="mt-4 gap-2" onClick={() => setShowAddMember(true)}>
                      ...
                      <CardContent className="py-5 px-5">
                        <div className="flex items-start justify-between gap-4">
                          ...
                          <div className="flex flex-col gap-2 shrink-0">
                            <Button  size="sm" className="gap-1 text-xs" onClick={() => { setSelectedJournal(j); setActiveTab("overview"); }}>
        ...
        <Dialog open={showCreate} onOpenChange={setShowCreate}>
          <DialogContent className="max-w-lg">
            ...
            <DialogFooter>
              ...
              <Button  onClick={handleCreateJournal} disabled={saving || !form.name}>
        ...
        <Dialog open={showAddMember} onOpenChange={setShowAddMember}>
          <DialogContent className="max-w-sm">
            ...
            <DialogFooter>
              ...
              <Button  onClick={handleAddMember} disabled={!memberForm.display_name}>Add Member</Button>
            </DialogFooter>
          </DialogContent>
        </Dialog>
      </div>
