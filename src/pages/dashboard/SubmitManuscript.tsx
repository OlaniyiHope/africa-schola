      ...
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        {!submitted ? (
          <div className="bg-card rounded-xl border border-border p-6 space-y-5">
            ...
            <Button  size="lg" className="w-full gap-1" onClick={handleSubmit} disabled={submitting || !title || !journal}>
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-3">
              <Link to="/dashboard/publishing/track">
                <Button size="sm" className="gap-1">Track Submission</Button>
              </Link>
        ...
        <Dialog open={showShareModal} onOpenChange={setShowShareModal}>
          <DialogContent className="max-w-sm">
            ...
            <div className="flex flex-col gap-2 mt-2">
              <Button  size="sm" className="gap-1" onClick={() => { setShowShareModal(false); toast({ title: "Shared!", description: "Your update has been posted to the community." }); }}>
                Share Publicly
              </Button>
