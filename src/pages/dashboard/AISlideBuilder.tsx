        ...
        {step === 2 && (
          <div className="bg-card rounded-xl border border-border p-6 space-y-5">
            ...
            <div className="flex gap-3">
              ...
              <Button  size="lg" className="flex-1" onClick={() => setStep(3)} disabled={!prompt}>Continue <ArrowRight className="h-4 w-4 ml-1" /></Button>
            </div>
          </div>
        )}
        ...
        {step === 3 && (
          <div className="bg-card rounded-xl border border-border p-6 space-y-5">
            ...
            <div className="flex gap-3">
              ...
              <Button  size="lg" className="flex-1" onClick={() => setStep(4)}>Continue <ArrowRight className="h-4 w-4 ml-1" /></Button>
            </div>
          </div>
        )}
        ...
        {step === 4 && (
          <div className="bg-card rounded-xl border border-border p-6 space-y-5">
            ...
            <div className="flex gap-3">
              ...
              <Button  size="lg" className="flex-1 gap-1" onClick={startGeneration}>
            ...
            <Dialog open={showCompletionModal} onOpenChange={setShowCompletionModal}>
              <DialogContent className="max-w-sm">
                ...
                <div className="flex flex-col gap-2 mt-3">
                  <Button  size="sm" onClick={() => setShowCompletionModal(false)}>Edit Slides</Button>
              ...
              <div className="lg:col-span-2 bg-card rounded-xl border border-border p-6 min-h-[400px] flex flex-col">
                {editingSlide === selectedSlide ? (
                  <div className="space-y-3 flex-1">
                    ...
                    <Button  size="sm" onClick={() => setEditingSlide(null)}>Done Editing</Button>
                  </div>
                ) : (
