...
// interface NavChild { icon: any; label: string; to: string; children?: NavChild[];}
// interface NavItem  { icon: any; label: string; to: string; children?: NavChild[]; }
// function NavChildRow({ child }: { child: NavChild }) {
//   const location = useLocation();
//   const isChildActive = child.children?.some(c =>
...
//   // has grandchildren — render as a mini collapsible
//   return (
//     <div>
//       <button
//         onClick={() => setOpen(v => !v)}
...
//         onMouseLeave={e => { if (!isActive) { e.currentTarget.style.background = isActive ? "rgba(234,88,12,0.10)" : "transparent"; e.currentTarget.style.color = isActive ? "#ea580c" : "rgba(255,255,255,0.5)"; }}}
//       >
//         <child.icon size={13} style={{ flexShrink: 0 }} />
...
//                   fontWeight: childActive ? 600 : 400, fontSize: "0.815rem",
//                 }}
...
//       {/* Left: sidebar collapse button (visible on desktop too, like screenshot) */}
//       <button
//         onClick={onMenuClick}
//         style={{ background: "none", border: "none", cursor: "pointer", display: "flex", color: "#6b7280", flexShrink: 0 }}
//       >
//         <Menu size={20} />
//       </button>
...
//         flex: 1, maxWidth: 380,
//         display: "flex", alignItems: "center", gap: "0.5rem",
//         background: "#f3f4f6", borderRadius: 8, padding: "0.45rem 0.875rem",
//       }}>
//         <Search size={14} style={{ color: "#9ca3af", flexShrink: 0 }} />
//         <input
//           placeholder="Search..."
//           style={{ flex: 1, border: "none", background: "transparent", outline: "none", fontSize: "0.85rem", color: "#374151" }}
//         />
//       </div>

//       {/* Right: credits + icons + avatar */}
...
//             fontSize: "0.55rem", fontWeight: 800, color: "#fff", padding: "0 3px",
//           }}>1</span>
//         </button>
...
//           style={{ position: "relative", display: "flex", color: "#6b7280", padding: 2 }}
//         >
//           <Bell size={18} />
//           <span style={{
//             position: "absolute", top: -3, right: -4,
...
//                 { icon: Settings, label: "Settings",     to: `/dashboard/${role}/settings` },
