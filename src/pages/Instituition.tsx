...
const serviceBlocks = [
  {
    icon: GraduationCap,
    title: "Teaching & Faculty Deployment",
    items: [
      "Part-time and adjunct lecturing",
      "Online and blended EdTech delivery",
      "Specialist modules and masterclasses",
      "Academic supervision and mentoring",
      "Program leadership roles (for licensing)",
    ],
  ...
  {
    icon: Search,
    title: "Research & Institutional Projects",
    items: [
      "Commissioned institutional research",
      "Industry-linked / policy research",
  ...
  {
    icon: Award,
    title: "Academic Validation & Peer Review",
    items: [
      "Peer review panels",
  ...
  {
    icon: BookOpen,
    title: "Curriculum & Program Structuring",
    items: [
      "Curriculum design & academic review",
      "Learning material development",
      "Program architecture alignment",
      "Accreditation-ready documentation",
      "Knowledge translation to industry",
    ],
